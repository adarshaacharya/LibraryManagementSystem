...
char catagories[][15]={"Bsc.CSIT","B.IT","BBA","BBS","B.HM","B.Ed"};
...
gotoxy(20,7);
printf("\xDB\xDB\xDB\xDB\xB2 1. Bsc.CSIT");
gotoxy(20,9);
printf("\xDB\xDB\xDB\xDB\xB2 2. B.IT");
gotoxy(20,11);
printf("\xDB\xDB\xDB\xDB\xB2 3. BBA");
gotoxy(20,13);
printf("\xDB\xDB\xDB\xDB\xB2 4. BBS");
gotoxy(20,15);
printf("\xDB\xDB\xDB\xDB\xB2 5. B.HM");
gotoxy(20,17);
printf("\xDB\xDB\xDB\xDB\xB2 6. B.Ed");
gotoxy(20,19);
...
fclose(fp);
remove("adarsha.dat");
rename("test.dat","adarsha.dat"); //copy all item from temporary file to fp except that
fp=fopen("adarsha.dat","rb+");    //we want to delete
if(findbook=='t')
{
gotoxy(10,10);
...
gotoxy( 15,20);
printf("Enter Your Choice");
fp=fopen("adarsha.dat","rb+"); //open file for reading propose
